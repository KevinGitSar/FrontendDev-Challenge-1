    ...
    <>
        ...
        <div className="w-10/12 mx-auto mt-10 mb-5 bg-white border rounded-xl">
            <ul className="flex justify-center">
                ...
                <button onClick={() => mainLabSwitch()}><li className={mainTabSwitch == 1 ? 'w-[100px] h-[40px] text-center table-cell align-middle rounded-l-xl font-bold text-lg text-white bg-[#498CCE]' : 'w-[100px] h-[40px] text-center table-cell align-middle rounded-l-xl font-bold text-lg'}>Labs</li></button>
                <button onClick={() => mainChallengeSwitch()}><li className={mainTabSwitch == 2 ? 'w-[100px] h-[40px] text-center table-cell align-middle font-bold text-lg text-white bg-[#498CCE] px-2' : 'w-[100px] h-[40px] text-center table-cell align-middle rounded-l-xl font-bold text-lg px-2'}>Challenges</li></button>
                <button onClick={() => mainResourceSwitch()}><li className={mainTabSwitch == 3 ? 'w-[100px] h-[40px] text-center table-cell align-middle font-bold text-lg text-white bg-[#498CCE] px-2' : 'w-[100px] h-[40px] text-center table-cell align-middle rounded-l-xl font-bold text-lg px-2'}>Resources</li></button>
                <button onClick={() => mainProjectSwitch()}><li className={mainTabSwitch == 4 ? 'w-[100px] h-[40px] text-center table-cell align-middle rounded-r-xl font-bold text-lg text-white bg-[#498CCE]' : 'w-[100px] h-[40px] text-center table-cell align-middle rounded-l-xl font-bold text-lg'}>Projects</li></button>
            </ul>
        </div>

        {/* Secondary Tabs dependent on main tabs */}
        {/* Labs Tab */}
        <div className={mainTabSwitch == 1 ? 'w-10/12 mx-auto my-5 bg-white border rounded-xl' : 'hidden'}>
            <ul>
                <a href="#!" onClick={() => labTab1()}><li className={subLabSwitch == 1 ? 'py-2 pl-4 bg-[#498CCE] text-white font-bold rounded-t-xl' : 'py-2 pl-4 font-bold rounded-t-xl'}>Labs</li></a>
                <a href="#!" onClick={() => labTab2()}><li className={subLabSwitch == 2 ? 'py-2 pl-4 bg-[#498CCE] text-white font-bold rounded-b-xl' : 'py-2 pl-4 font-bold rounded-b-xl'}>Lab Programs</li></a>
            </ul>
        </div>

        {/* Challenge Tab */}
        <div className={mainTabSwitch == 2 ? 'w-10/12 mx-auto my-5 bg-white border rounded-xl' : 'hidden'}>
            <ul>
                <a href="#!" onClick={() => challengeTab1()}><li className={subChallengeSwitch == 1 ? 'py-2 pl-4 bg-[#498CCE] text-white font-bold rounded-t-xl' : 'py-2 pl-4 font-bold rounded-t-xl'}>Challenges</li></a>
                <a href="#!" onClick={() => challengeTab2()}><li className={subChallengeSwitch == 2 ? 'py-2 pl-4 bg-[#498CCE] text-white font-bold rounded-b-xl' : 'py-2 pl-4 font-bold rounded-b-xl'}>Challenge Paths</li></a>
            </ul>
        </div>

        {/* Resource Tab */}
        <div className={mainTabSwitch == 3 ? 'w-10/12 mx-auto my-5 bg-white border rounded-xl' : 'hidden'}>
            <ul>
                <a href="#!" onClick={() => resourceTab1()}><li className={subResourceSwitch == 1 ? 'py-2 pl-4 bg-[#498CCE] text-white font-bold rounded-t-xl' : 'py-2 pl-4 font-bold rounded-t-xl'}>Resources Modules</li></a>
                <a href="#!" onClick={() => resourceTab2()}><li className={subResourceSwitch == 2 ? 'py-2 pl-4 bg-[#498CCE] text-white font-bold' : 'py-2 pl-4 font-bold'}>Resource Collections</li></a>
                <a href="#!" onClick={() => resourceTab3()}><li className={subResourceSwitch == 3 ? 'py-2 pl-4 bg-[#498CCE] text-white font-bold rounded-b-xl' : 'py-2 pl-4 font-bold rounded-b-xl'}>Resource Paths</li></a>
            </ul>
        </div>
        ...
        <div className={mainTabSwitch == 1 || mainTabSwitch == 2 || mainTabSwitch == 3 ? 'w-10/12 mx-auto my-5 bg-white border rounded-xl' : 'hidden'}>
            <div className="flex justify-between px-4 pt-4">
                <h1 className="text-2xl font-extrabold">Filters</h1>
                <a href="#!" className="font-semibold hover:text-[#498CCE]">Clear All</a>
            </div>
            <ul>
                <button onClick={() => toggleDuration()} className="w-full text-left"><li className="py-2 my-4 bg-[#498CCE] pl-1 text-white"><img src={durationToggle ? 'down-arrow-240.png' : 'right-arrow-240.png'} className="w-[15px] float-left m-1" />DURATION</li></button>
                ...
                <button onClick={() => toggleLevel()} className="w-full text-left"><li className="py-2 my-4 bg-[#498CCE] pl-1 text-white"><img src={levelToggle ? 'down-arrow-240.png' : 'right-arrow-240.png'} className="w-[15px] float-left m-1" />LEVEL</li></button>
                ...
                <button onClick={() => toggleOrganization()} className="w-full text-left"><li className="py-2 my-4 bg-[#498CCE] pl-1 text-white"><img src={organizationToggle ? 'down-arrow-240.png' : 'right-arrow-240.png'} className="w-[15px] float-left m-1" />ORGANIZATIONS</li></button>
                ...
                <button onClick={() => toggleSkills()} className="w-full text-left"><li className="py-2 my-4 bg-[#498CCE] pl-1 text-white"><img src={durationToggle ? 'down-arrow-240.png' : 'right-arrow-240.png'} className="w-[15px] float-left m-1" />SKILLS</li></button>
        ...
        <div className={mainTabSwitch == 4 ? 'w-10/12 mx-auto my-5 bg-white border rounded-xl' : 'hidden'}>
            <div className="flex justify-between px-4 pt-4">
                <h1 className="text-2xl font-extrabold">Filters</h1>
                <a href="#!" className="font-semibold hover:text-[#498CCE]">Clear All</a>
            </div>
            <ul>
                <button onClick={() => toggleStatus()} className="w-full text-left"><li className="py-2 my-4 bg-[#498CCE] pl-1 text-white"><img src={statusToggle ? 'down-arrow-240.png' : 'right-arrow-240.png'} className="w-[15px] float-left m-1" />STATUS</li></button>
        ...
        <div className="w-10/12 mx-auto my-5 bg-white border rounded-xl">
            ...
            <div className="flex justify-end my-8">
                ...
                <select name="sortby" id="sortby" className="border rounded-lg px-4 py-2 pr-10 mr-4 ml-2 text-xl">
        ...
        {/*Labs Content */}
        <div className={mainTabSwitch == 1 ? 'w-10/12 mx-auto my-5 border-b' : 'hidden'}>
        ...
        {/*Challenges Content */}
        <div className={mainTabSwitch == 2 ? 'w-10/12 mx-auto my-5 border-b' : 'hidden'}>
            
            {/* Content #1 */}
            <div className="bg-white border rounded-xl mb-5">
                <img src="https://prepr-preprlabs-prod-bucket.s3.ca-central-1.amazonaws.com/uploads/challenge/DGIMMt3qAlFSXjNfOJ0NsrOsW.png" className="p-5"/>
        ...
        {/*Resources Content */}
        <div className={mainTabSwitch == 3 ? 'w-10/12 mx-auto my-5 border-b' : 'hidden'}>
            ...
            {/* Fake Content #3 */}
            <div className="bg-white border rounded-xl mb-5">
                <img src="https://d3f06rtlkr354b.cloudfront.net/uploads/resources/image/QCpU1zh5cdItBUQRlBsrGkpVsI5kBDu3oHfGiEhI.png" className="p-5"/>
        ...
        <div className={mainTabSwitch == 4 ? 'w-10/12 mx-auto my-5 border-b' : 'hidden'}>
